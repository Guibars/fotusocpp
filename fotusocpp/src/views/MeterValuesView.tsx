  ...
  return (
    <div className="flex-1 overflow-y-auto px-6 md:px-8 py-8 custom-scrollbar relative z-10 w-full h-full text-slate-800">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <button 
          onClick={loadData} 
          className="flex items-center gap-2 px-4 py-2 bg-white border border-[#e2e8f0] text-slate-700 hover:text-[#0e467f] hover:bg-slate-100 rounded-full transition-all text-sm font-semibold shadow-sm hover:shadow active:scale-95"
        >
